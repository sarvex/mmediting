...
METRICS_MAPPING = {
    'FID': {'keys': ['FID-Full-50k/fid'], 'tolerance': 0.5, 'rule': 'less'},
    'PSNR': {'keys': ['PSNR'], 'tolerance': 0.1, 'rule': 'larger'},
    'SSIM': {
        'keys': ['MattingSSIM', 'SSIM'],
        'tolerance': 0.1,
        'rule': 'larger',
    },
    'l1 error': {'keys': ['MAE'], 'tolerance': 0.1, 'rule': 'less'},
    'CONN': {'keys': ['ConnectivityError'], 'tolerance': 0.1, 'rule': 'less'},
    'GRAD': {'keys': ['GradientError'], 'tolerance': 0.1, 'rule': 'less'},
    'MSE': {'keys': ['MSE', 'MattingMSE'], 'tolerance': 0.1, 'rule': 'less'},
    'SAD': {'keys': ['SAD'], 'tolerance': 0.1, 'rule': 'less'},
    'NIQE (Y)': {'keys': ['NIQE'], 'tolerance': 0.1, 'rule': 'less'},
    ...
    'Set5 SSIM': {'keys': ['Set5/SSIM'], 'tolerance': 0.1, 'rule': 'larger'},
    'Set5 PSNR': {'keys': ['Set5/PSNR'], 'tolerance': 0.1, 'rule': 'larger'},
    'Set14 SSIM': {'keys': ['Set14/SSIM'], 'tolerance': 0.1, 'rule': 'larger'},
    'Set14 PSNR': {'keys': ['Set14/PSNR'], 'tolerance': 0.1, 'rule': 'larger'},
    'DIV2K SSIM': {'keys': ['DIV2K/SSIM'], 'tolerance': 0.1, 'rule': 'larger'},
    'DIV2K PSNR': {'keys': ['DIV2K/PSNR'], 'tolerance': 0.1, 'rule': 'larger'},
} | liif_metrics
